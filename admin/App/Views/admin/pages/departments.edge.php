                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="#" class="btn btn-tool btn-sm btn-outline-success" data-toggle="modal" data-target="#modal-add-department">
                                ...
                                @foreach($departments as $department)
                                    <tr>
                                        ...
                                        <td class="project-actions text-right">
                                            <div class="btn-group">
                                                <a href="{!! route('department_delete', ['departmentId' => $department->ID]) !!}"
