...
@section('content')
    ...
    <section class="content data-table-content">
        <div class="container-fluid">
            <form action="{!! route('page_edit_action', ['pageId' => $page_id]) !!}" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Page sub title</span>
                                        </div>
                                        <input type="text" name="sub_title" class="form-control" aria-describedby="pageSlug"
                                               value="{!! $page->sub_title !!}"
                                               placeholder="Write your page sub title here ...">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="seo_keywords" value="{{$page->seo_keyword}}" placeholder="write some tags">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="mb-2">
                                        <img src="{!! !empty($page->cover_image) ? get_asset('uploads/pages/' . $page->cover_image) : '' !!}" class="img-fluid img-thumbnail" id="preview"/>
                                    </div>
                                    <div class="input-group">
